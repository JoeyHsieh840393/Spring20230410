...
public class UserController {
	...
	private List<String> sexData = Arrays.asList("男", "女", "不表態", "生理男心理女");
	private List<String> interestData = Arrays.asList("飛控", "爬山", "看書", "打球", "手遊");
	private Map<String, List> dataMap = new LinkedHashMap<String, List>();
