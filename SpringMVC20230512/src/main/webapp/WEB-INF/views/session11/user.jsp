...
<body style="padding: 15px">
	<table>
		<tr>
			<td>
				<spform:form class="pure-form" method="post" modelAttribute="user" action="${pageContext.request.contextPath}/mvc/session11/user/${ index }">
					...
					<fieldset>
						...
						學歷：<spform:select path="education">
								...
								<spform:options items="${ dataMap.educationData }" itemValue="id" itemLabel="name" ></spform:options>
							</spform:select><p>
