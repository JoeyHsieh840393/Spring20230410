...
//	@Value("${user.age}")
	...
	@Value(value = "#{${nickname:{'Sunny','Beauty','Grace'}}}") //#{${__:{__}}}
//	@Value("${user.nickname}")
...
//	@Value("#{${user.hobbies}}") // 注意：要包在 #{} 裡面
	...
	public User(String username, Integer age, String[] nickname, Set<String> subjects, List<Integer> scores,
